<?php 
 /*
Template Name: Team-Expert Page Template
*/
get_header(); 
?>
       ...
       $args = array(
        ...
        'tax_query'=> array(
            array(
                ...
                'field'=>'name',
                'terms' => get_queried_object()->post_title,
            )
        )
        );
        ...
        ?>
          ...
          <div class="col-lg-6">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="<?php  echo esc_url($image_info['url']) ?>" onerror="this.src='<?php echo get_template_directory_uri() ?>/assets/img/logo.png'"  class="img-fluid" alt="<?php echo the_title(); ?>"></div>
