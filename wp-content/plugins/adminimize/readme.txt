=== Adminimize ===
Contributors: wp_media, krafit, Bueltge
...
= 1.11.4 (2017-12-14) =
* Fixed hide of menu items, if you use custom menu, see [wiki page](https://github.com/wp-media/Adminimize/wiki/Custom-Menu-Order)
...
* Added filter hook `adminimize_nopage_access_message` to change the message for no access to a page. see the [wiki](https://github.com/wp-media/Adminimize/wiki/Filter-Hooks)
...
= Translations =
You can contribute to this plugin by translating it via [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/adminimize/).
...
Please send a [review](https://wordpress.org/support/view/plugin-reviews/adminimize).
